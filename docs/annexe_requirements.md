# Annexe — Requirements et dépendances Python
...
Cette annexe présente les dépendances utilisées par le projet et explique leur utilité.

Le fichier de référence pour l'installation est :
...
Ces modules font partie de Python et ne sont pas installés avec `pip`.
